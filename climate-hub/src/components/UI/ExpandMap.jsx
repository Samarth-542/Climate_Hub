...
export function LocationMap({
  ...
  return (
    ...
    >
      <motion.div
        className="relative overflow-hidden rounded-2xl bg-white border border-slate-200 shadow-xl"
        style={{
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-slate-100/20 via-transparent to-slate-100/40" />
        ...
        <AnimatePresence>
          {isExpanded && (
            ...
            >
              ...
              <motion.div
                className="absolute top-[40%] left-[10%] w-[15%] h-[20%] rounded-sm bg-slate-500/30 border border-slate-500/20"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.4, delay: 0.5 }}
              />
              <motion.div
                className="absolute top-[15%] left-[35%] w-[12%] h-[15%] rounded-sm bg-slate-500/25 border border-slate-500/15"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.4, delay: 0.6 }}
              />
              <motion.div
                className="absolute top-[70%] left-[75%] w-[18%] h-[18%] rounded-sm bg-slate-500/28 border border-slate-500/18"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.4, delay: 0.7 }}
              />
              <motion.div
                className="absolute top-[20%] right-[10%] w-[10%] h-[25%] rounded-sm bg-slate-500/22 border border-slate-500/15"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.4, delay: 0.55 }}
              />
              <motion.div
                className="absolute top-[55%] left-[5%] w-[8%] h-[12%] rounded-sm bg-slate-500/20 border border-slate-500/12"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.4, delay: 0.65 }}
              />
              <motion.div
                className="absolute top-[8%] left-[75%] w-[14%] h-[10%] rounded-sm bg-slate-500/22 border border-slate-500/15"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
          ...
          <div className="flex items-start justify-between">
            ...
            <motion.div
              ...
              animate={{
                ...
                backgroundColor: isHovered ? "hsl(222, 47%, 11%, 0.08)" : "hsl(222, 47%, 11%, 0.05)",
              }}
